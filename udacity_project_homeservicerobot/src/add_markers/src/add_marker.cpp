...
// 0: exists at origin; 1: disappear at origin;
// 2: exists at target; 3: disappear at target;
int marker_current_state = 0;
...
int main( int argc, char** argv )
{
  ...
  while (ros::ok())
  {
    ...
    switch (marker_current_state)
    {
    case 0:
    {
      // Set the namespace and id for this marker.  This serves to create a unique ID
      // Any marker sent with the same namespace and id will overwrite the old one
      marker.ns = "markers_at_origin";
      marker.id = 0;
